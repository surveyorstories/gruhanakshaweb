    ...
    const features = [
        {
            ...
            description: 'Accelerate your mapping process with tools designed for SVAMITVA deliverables, reducing manual effort.',
        },
        {
            ...
            description: 'Generate maps, reports, and data in formats that comply with the official SVAMITVA scheme guidelines.',
        },
        {
            ...
            description: 'Ensure data integrity with built-in validation checks and quality control tools tailored for cadastral data.',
        },
        {
            ...
            description: 'Designed for GIS professionals, the user-friendly interface integrates seamlessly into the QGIS environment.',
        },
        {
            ...
            description: 'Efficiently process large datasets and multiple village areas at once, saving valuable time and resources.',
        },
        {
            icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.572L16.5 21.75l-.398-1.178a3.375 3.375 0 00-2.456-2.456L12.5 17.25l1.178-.398a3.375 3.375 0 002.456-2.456L16.5 13.5l.398 1.178a3.375 3.375 0 002.456 2.456L20.5 17.25l-1.178.398a3.375 3.375 0 00-2.456 2.456z" /></svg>,
            title: 'Dynamic Symbology',
            description: 'Apply rule-based styling and labeling automatically to visualize your cadastral data clearly and consistently.',
        }
    ];
            ...
            <div className="features-container">
                <div className="features-header">
                    <h2 className="features-title">
                        Everything You Need for SVAMITVA Success
                    </h2>
                    <p className="features-subtitle">
                        Gruhanaksha is packed with features designed to make your cadastral mapping tasks faster, easier, and more accurate.
                    </p>
                </div>
